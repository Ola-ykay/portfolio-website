  ...
  return (
    ...
    <motion.small
      ...
      <motion.p initial={{opacity:0, x:100}}
       ...
       I am hardworking, innovative, goal driven and have keen interest in frontend engineering 
       as I love to create accessible applications with beautiful and delightful user experiences,
        solve problems and share knowledge. I aim to make the world a better place with my skillset.
